...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100671079, ; uint32_t jnienv_initialize_method_token (0x6001e67)
	i32 100671078, ; uint32_t jnienv_registerjninatives_method_token (0x6001e66)
...
@dso_cache = dso_local local_unnamed_addr global [528 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 597080708761030312, ; hash 0x84941bdbbf08ea8, from name: aot-LifePointsTCG.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-LifePointsTCG.dll.so
		ptr null; void* handle (0x0)
	}, ; 15
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 2646401390452077570, ; hash 0x24b9e80b1afef402, from name: aot-LifePointsTCG
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-LifePointsTCG.dll.so
		ptr null; void* handle (0x0)
	}, ; 70
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.24_name, ; name: libaot-Plugin.Maui.Audio.dll.so
		ptr null; void* handle (0x0)
	}, ; 144
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 11036031791103605372, ; hash 0x9927dc714ea5fa7c, from name: LifePointsTCG.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-LifePointsTCG.dll.so
		ptr null; void* handle (0x0)
	}, ; 302
	...
	%struct.DSOCacheEntry {
		i64 11503885935357109650, ; hash 0x9fa6034ed992a592, from name: libaot-LifePointsTCG.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-LifePointsTCG.dll.so
		ptr null; void* handle (0x0)
	}, ; 323
	...
	%struct.DSOCacheEntry {
		i64 13663681948036258852, ; hash 0xbd9f2656a49e5c24, from name: LifePointsTCG
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-LifePointsTCG.dll.so
		ptr null; void* handle (0x0)
	}, ; 389
	...
	%struct.DSOCacheEntry {
		i64 17977386237719610459, ; hash 0xf97c8188f146045b, from name: libaot-LifePointsTCG
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-LifePointsTCG.dll.so
		ptr null; void* handle (0x0)
	}, ; 506
...
@.env.3 = private unnamed_addr constant [37 x i8] c"bbea5c37-ac80-45f8-ba0c-bdb9ab37c037\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [30 x i8] c"com.companyname.lifepointstcg\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [28 x i8] c"libaot-LifePointsTCG.dll.so\00", align 16
...
@.DSOCacheEntry.24_name = private unnamed_addr constant [32 x i8] c"libaot-Plugin.Maui.Audio.dll.so\00", align 16
